...
clf_1 = LogisticRegression()
clf_2 = DecisionTreeClassifier()
print("LR: ",np.mean(cross_val_score(clf_1,X_transformed,y,cv=10,scoring="accuracy")))
print("DT: ",np.mean(cross_val_score(clf_2,X_transformed,y,cv=10,scoring="accuracy")))
